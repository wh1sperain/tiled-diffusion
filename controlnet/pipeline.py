...
from utils import wrap_edges_x
        ...
        **kwargs,
        ...
        if isinstance(controlnet, ControlNetModel):
            image = self.prepare_image(
                image=image,
                width=width + 2 * self.vae_scale_factor * max_width,
                # width=width,
                height=height,
        ...
        # image = image[:, :, :, max_width * self.vae_scale_factor:-max_width * self.vae_scale_factor]
